...
See [classic/H2H correction work](implementation-slice-34.md), [release execution order](release-execution-plan.md) and [slice 33](implementation-slice-33.md) for the Git checkpoint, mandatory CI and reviewed match-timeline work.
...
- Overall/classic-league/H2H correction projections with shared published calculations, private-group redaction, aggregate affected-prize decisions and stale-confirmation protection across result/group/edition/prize dependencies.
