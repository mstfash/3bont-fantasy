...
| Corrections             | Existing overall-rank previews, persistent overrides, finality controls and delivered-prize correction cases                             | Classic-group/H2H projections; hypothetical prize allocations; one global-fact preview covering every affected competition; controlled historical rules recalculation                                                      |
...
1. Reuse the canonical classic/H2H ranking and prize eligibility functions to project affected local results from proposed score revisions.
