...
| Deployment and recovery | Pinned HTTPS, guarded identity startup, release preflight and encrypted local PITR proof exist (slices 41–42)                            | Named isolated staging host/domain; verified sender; monitoring/alert destination; off-host backup restore into a clean database; deadline load and interrupted-worker rehearsal; retention/exceptional privacy procedures |
