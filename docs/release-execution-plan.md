...
| ----------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Git and CI              | Checkpoint pushed; protection enforced; PR 7 merged with all remote checks green                                                         | Green GitHub Actions gate on the merged main commit; documented local reproduction                                                                                                                                         |
...
| Corrections             | Overall/classic/H2H previews implemented; persistent overrides, finality controls and delivered-prize correction cases                   | Hypothetical prize allocations; one global-fact preview covering every affected competition; controlled historical rules recalculation                                                                                     |
...
1. Classic/H2H projections now reuse the canonical published calculations (slice 34). Next, reuse prize eligibility/allocation functions for hypothetical awards with explicit financial read permissions.
2. Resolve every competition/gameweek assignment of a changed real fixture before displaying a global correction preview; keep scoped staff permissions explicit.
3. Bind confirmation to source facts, overrides, locked lineups, rules versions, group membership/H2H editions and prize decision revisions. Any concurrent material change invalidates the preview.
...
5. Add a separate authorized historical-rules replay only after these projections are trustworthy. Ordinary future-rule editing remains unchanged.
